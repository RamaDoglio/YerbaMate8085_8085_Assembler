...
function getObservation(inst: string): string {
  ...
  switch (op) {
    ...
    case 'JP': case 'JM': case 'JPE': case 'JPO':
      return `Salto a la posici\u00f3n [${args[0]}]`
    case 'CALL': return `Llamada a [${args[0]}]`
    case 'RLC': return 'Rotar A izq'
    case 'RRC': return 'Rotar A der'
    case 'RAL': return 'Rotar A izq c/CY'
    case 'RAR': return 'Rotar A der c/CY'
    case 'DAA': return 'Ajuste decimal A'
    case 'EI': return 'Habilitar INT'
    case 'DI': return 'Deshabilitar INT'
    case 'RIM': return 'Leer mascara INT'
    case 'SIM': return 'Escribir mascara INT'
...
export function generatePDF(
  ...
  doc.setFontSize(14)
  doc.text('ARQUITECTURA DE COMPUTADORAS', pageW / 2, y, { align: 'center' })
  y += 8
  ...
  doc.text(`Fecha: ${today}`, pageW - margin, y, { align: 'right' })
  y += 6
  doc.text(`Ejercicio N\u00b0: ${exerciseNum}`, margin, y)
  doc.text(`Hoja N\u00b0: ${sheetNum}`, pageW - margin, y, { align: 'right' })
  y += 10
  ...
  autoTable(doc, {
    head: [[
      { content: 'Ins. N\u00b0', styles: { fontStyle: 'bold' } },
      { content: 'Direcci\u00f3n', styles: { fontStyle: 'bold' } },
      { content: 'Mem\u00f3nico', styles: { fontStyle: 'bold' } },
      { content: 'OP.CODE', styles: { fontStyle: 'bold' } },
      { content: 'Observaci\u00f3n', styles: { fontStyle: 'bold' } },
    ]],
    body: plantBody,
    startY: y,
  ...
  const traceHead = [
    [
      { content: 'POSC.\nMEMORIA', rowSpan: 2, styles: { fontStyle: 'bold' } },
      { content: 'MEMORIA', rowSpan: 2, styles: { fontStyle: 'bold' } },
      { content: 'Ins.\nN\u00b0', rowSpan: 2, styles: { fontStyle: 'bold' } },
      { content: 'REGISTROS', colSpan: 8, styles: { fontStyle: 'bold' } },
      { content: 'BANDERAS', colSpan: 4, styles: { fontStyle: 'bold' } },
    ],
    [
