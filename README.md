...
Download the installer or portable version from [Releases](https://github.com/tu-usuario/YerbaMate8085/releases).

Descargar el instalador o versión portable desde [Releases](https://github.com/tu-usuario/YerbaMate8085/releases).
